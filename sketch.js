...
var goodHabit21G,goodHabit23G,goodHabit22G,goodHabit24G,goodHabit25G,goodHabit26G,goodHabit27G,photo3G;
var sword;
//Game States
var PLAY=1;
var END=0;
var gameState=1;
var time=0;
var tree1,tree2,tree3,house1,house2,photo3;
...
function preload(){
 ...
 // gamOverImg=loadImage("gameOverImg.jpg")
...
function draw() {
 ...
 if(boy.x<754){
  ...
  if(frameCount%90==0){
    ...
    if (cashG.isTouching(boy) ||photo3G.isTouching(boy) ||goodHabit16G.isTouching(boy) ||goodHabit17G.isTouching(boy) || goodHabit18G.isTouching(boy)) {
  ...
  if(gameState===END){
    ...
    if(typeof tree2==="object"){
      tree2.velocityY=0;
     
    }
    if(typeof tree3==="object"){
      tree3.velocityY=0;
     
    }
    if(typeof house1==="object"){
      house1.velocityY=0;
      
    }
    if(typeof house2==="object"){
      house2.velocityY=0;
    }
    /*if(typeof photo3==="object"){
      photo3.destroy();
    }*/
    console.log(typeof tree2);
    path.velocityY=0;
    photo3G.destroyEach();
    //tree1.velocityY=0;
   // tree2.velocityY=0;
...
function createTree1(){
   tree1=createSprite(280,40,10,10);
 tree1.scale=2;
...
function createTree2(){
    tree2=createSprite(2635,40,10,10);
 tree2.scale=1;
...
function createTree3(){
  tree3=createSprite(280,40,10,10);
 tree3.scale=1;
...
function createHouse1(){
    house1=createSprite(280,40,10,10);
  house1.scale=2.5;
...
function createHouse2(){
  house2=createSprite(2635,40,10,10);
  house2.scale=2.5;
...
function createPhoto3(){
   photo3=createSprite(Math.round(random(width/2-100, height),40, 10, 10));
